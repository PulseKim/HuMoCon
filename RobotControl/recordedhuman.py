...
modelMan = PPO2.load("/home/sonic/Project/Alien_Gesture/data/TiltMan/2022-01-21-12-41-19_Iteration_8200.pkl")
...
env.generateSitPD()
env.generateStandPD()
reading_folder = '/home/sonic/Project/RobotControl/filmed_data/LongSeqMod2/'
...
np.savetxt(reading_folder + '/new_ref_motion.txt', ref_motion[1:,:],fmt='%1.3f')
np.savetxt(reading_folder + '/new_robot_motion.txt', robot_motion[1:,:],fmt='%1.3f')
