...
setup(
    name='raisim_gym_tiltman',
    version='0.0.0',
    author='Jemin Hwangbo',
    license="proprietary",
    packages=find_packages(),
    author_email='jemin.hwangbo@gmail.com',
    description='gym for raisim using tf.',
    long_description='',
    ext_modules=[CMakeExtension('_raisim_gym_tiltman')],
    install_requires=['ruamel.yaml', 'numpy', 'tensorboard'],
